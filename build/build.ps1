...
Add-Content $TempFile "* datagrid-component JavaScript Library";
Add-Content $TempFile "* Authors: https://github.com/billclyde/datagrid-component/blob/master/README.md";
...
Add-Content $TempFile "(function (ko) {";
...
Foreach ($file in $files){
	...
	if ($fileContents[0].StartsWith("<!--")){
	    $compiledContent = "var " + $fileContents[0].TrimStart($commentStart).TrimEnd($commentEnd).Trim() + " = function(){ return '";
